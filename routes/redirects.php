...
Route::permanentRedirect('extending/permissions', '/control-panel/custom-permissions');
Route::permanentRedirect('permissions', '/control-panel/permissions');
Route::permanentRedirect('roles', '/control-panel/roles');
Route::permanentRedirect('user-groups', '/control-panel/user-groups');
