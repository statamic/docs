...
``` php
protected $tagNamespace = 'your-addon-slug';
```

Tags will then be callable as `{{ your-addon-slug::tag_name }}`. See [Namespaced Tags](/building-a-tag#namespaced-tags) for full details.
