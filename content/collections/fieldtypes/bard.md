...
options:
  ...
  -
    ...
    description: |
      ...
      You can choose from `h1`, `h2`, `h3`, `h4`, `h5`, `h6`, `bold`, `italic`, `underlined`, `strike` `unorderedlist`, `orderedlist`, `removeformat`, `blockquote`, `anchor`, `image`, `table`, `asset`, `code` (inline), and `codeblock`.
