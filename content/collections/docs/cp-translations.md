...
_Transations are community contributed so you find them to be incomplete shortly after an update._
...
You can specify a short 2 charachter language code (`es`) or the full 4 character regional code (`es_MX`).
