...
If you want to continue to keep users in a database, head over to [Storing Users in a Database in an Existing Laravel App](/troubleshooting/storing-users-in-a-database#in-an-existing-laravel-app) follow those steps.
