...
If you have [static caching](/static-caching) enabled, submitting dynamic forms will most likely end up in a `419 - session expired` error. This is the result of a [CSRF](https://laravel.com/docs/9.x/csrf) token mismatch.
