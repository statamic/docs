...
### Icons
**Affects apps or addons using Statamic's icon set.**

As part of the redesign, we've updated the icon set used in the Control Panel. This means that you may need to select new icons for your Bard/Replicator sets or CP Navigation items. 
...
The `export_as` option has been removed in favour of the new `export` folder convention, which copies files into an `export` folder in your starter kit package.
