...
The `export_as` option has been removed in favor of the new `export` folder convention, which copies files into an `export` folder in your starter kit package.
