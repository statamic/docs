...
Statamic supports [AMP]((https://amp.dev)) by providing a "pivoting" route that lets you serve an alternate set of views and layouts that conform to the AMP requirements.
